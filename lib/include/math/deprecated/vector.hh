...
namespace neutrino::math {
    ...
    class vector_3d : public vector_expression <vector_3d <T>, 3> {
        static_assert(neutrino::math::is_number_v <T>);
        ...
        public:
            ...
            constexpr explicit vector_3d(const T value) noexcept
            ...
            */
            ...
            constexpr vector_3d <T>& operator*=(const E& a) noexcept {
                static_assert(neutrino::math::is_number_v <E>);
                x *= a;
                y *= a;
                z *= a;
                return *this;
    ...
    class vector_2d : public vector_expression <vector_2d <T>, 2> {
        ...
        public:
            ...
            explicit constexpr vector_2d(const T value) noexcept
                : x(value), y(value) {
            };
        ...
        public:
            ...
            constexpr vector_nd(const Args&... args) noexcept
                ...
                static_assert(sizeof...(args) == N,
                              "vectorND: Number of arguments does not match the size of the vector.");
            }
